...
start_bg "adapter-linux" python "$ROOT/adapters/linux/DesktopAgent.Adapter.Linux/server.py"
...
echo "DesktopAgent started on Linux."
echo "Use: bash scripts/stop-linux.sh"
